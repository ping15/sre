    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(db_index=True, max_length=32, verbose_name="课程名称"),
                ),
                ...
                (
                    "require_authorized_training",
                    models.BooleanField(verbose_name="是否要求授权培训"),
                ),
                (
                    "certification_body",
                    models.JSONField(default=list, verbose_name="认证机构"),
                ),
            ],
        ),
    ]
